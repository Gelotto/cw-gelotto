...
use super::models::JurorVoteMetadata;
...
pub const JURY_VOTING_STARTS_AT: Item<Timestamp> = Item::new("voting_starts_at");
pub const JURY_TARGET_DURATION: Item<Duration> = Item::new("target_duration");
pub const JURY_MAX_DURATION: Item<Duration> = Item::new("max_duration");
